...
-   :material-keyboard-variant: __核心输入体系__
    ...
    [:octicons-arrow-right-24: 了解核心](core/aux_code.md)

-   :material-magic-staff: __Lua 魔法扩展__
    ---
    计算器、超级注释、符号包裹、动态时间戳... 探索让 Rime 拥有“超能力”的数十种微创新脚本。
    [:octicons-arrow-right-24: 探索魔法](lua/super_tips.md)

-   :material-cogs: __高阶定制与数据__
    ---
    掌握 `custom` 补丁的安全打法，自由管理线上拓展词库，打造完全属于你的私人输入方案。
    [:octicons-arrow-right-24: 进阶配置](advanced/custom_patch.md)
